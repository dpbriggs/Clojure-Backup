...
(def mytext "Two years ago, if you would have asked Amal Mohamud about human trafficking in Edmonton, she wouldn’t have been able to tell you much. It wasn’t until the 21-year-old watched a documentary on prostitution in Edmonton which featured an interview with a friend – someone Mohamud unknowingly knew was working as a prostitute – when she decided to get involved and volunteer with ACT Alberta, a local non-profit dedicated to ending human trafficking.")

(def scorewords (get-scored-terms mytext "trafficking"))
